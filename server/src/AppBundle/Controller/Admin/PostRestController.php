...
use AppBundle\Controller\HelperController;
...
/**
 * @Rest\View
 * @Rest\NamePrefix("admin_restpost_")
 */
class PostRestController extends HelperController
{
    /**
     * @ApiDoc(description="Execute remote action once identified and authorized as admin")
     *
